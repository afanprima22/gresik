...
class Purchase_sperpart extends MY_Controller {
	...
	public function view(){
		...
		$data = array(
			...
			'title_page' 	=> 'Transaction / Pembelian / Sperpart',
			'title' 		=> 'Kelolah Data',
			'c'				=> $c
			);

		$this->open_page('purchase_sperpart_v', $data);
	}
	...
	function general_post_data_detail(){
		...
		$data = array(
			...
			'purchase_detail_type' 			=> 3,//$this->input->post('i_type', TRUE),
