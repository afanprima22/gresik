...
class Receipt_sperpart_kendaraan extends MY_Controller {
	...
	public function view(){
		...
		$data = array(
			...
			'title_page' 	=> 'Transaction / Penerimaan / Sperpart Kendaraan',
			'title' 		=> 'Kelolah Data',
			'c'				=> $c
			);

		$this->open_page('receipt_sperpart_kendaraan_v', $data);
	}
