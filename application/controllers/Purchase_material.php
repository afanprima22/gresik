...
class Purchase_material extends MY_Controller {
	...
	public function view(){
		...
		$data = array(
			...
			'title_page' 	=> 'Transaction / Pembelian / Material',
			'title' 		=> 'Kelolah Data',
			'c'				=> $c
			);

		$this->open_page('purchase_material_v', $data);
	}
	...
	function general_post_data_detail(){
		...
		$data = array(
			...
			'purchase_detail_type' 			=> 4,//$this->input->post('i_type', TRUE),
