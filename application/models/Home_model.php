...
class Home_model extends CI_Model{
	...
	function get_checkin(){
		$sql = "SELECT count(*) as total FROM transactions a 
				JOIN reservations b on b.reservation_id = a.reservation_id
	...
	function get_customer(){
		$sql = "SELECT sum(reservation_qty) as total FROM transactions a 
				JOIN reservations b on b.reservation_id = a.reservation_id
				WHERE MONTH(transaction_date)";
		$query = $this->db->query($sql);
		$result = null; // inisialisasi variabel. biasakanlah, untuk mencegah warning dari php.
	...
	function get_profit(){
		$sql = "SELECT sum(transaction_cash) as total FROM transactions a 
				JOIN reservations b on b.reservation_id = a.reservation_id
				WHERE MONTH(transaction_date)";
		$query = $this->db->query($sql);
		$result = null; // inisialisasi variabel. biasakanlah, untuk mencegah warning dari php.
