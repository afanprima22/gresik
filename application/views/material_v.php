...
<script type="text/javascript">
    ...
    function search_data() { 
        $('#table1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Material/load_data/'
            },
            "columns": [
              {"name": "material_name"},
              {"name": "material_min"},
    ...
    function action_data(){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Material/action_data/',
    ...
    function delete_data(id) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Material/delete_data',
                data: 'id='+id,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
        ...
        $.ajax({
          ...
          success:function(data){
            for(var i=0; i<data.val.length;i++){
              document.getElementById("i_id").value = data.val[i].material_id;
              document.getElementById("i_name").value = data.val[i].material_name;
              document.getElementById("i_price").value = data.val[i].material_price;
