...
<script type="text/javascript">
    ...
    function search_data() { 
        $('#table1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Receipt_sperpart_industri/load_data/'
            },
            "columns": [
              {"name": "receipt_code"},
              {"name": "purchase_code"},
    ...
    function search_data_detail(id) { 
        $('#table2').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Receipt_sperpart_industri/load_data_detail/'+id
            },
            "columns": [
    ...
    function action_data(){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Receipt_sperpart_industri/action_data/',
    ...
    function delete_data(id) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Receipt_sperpart_industri/delete_data',
                data: 'id='+id,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function edit_data(id) {
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Receipt_sperpart_industri/load_data_where/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
    ...
    function select_list_purchase() {
        $('#i_purchase').select2({
          ...
          allowClear: true,
          ajax: {
            url: '<?php echo base_url();?>Purchase_sperpart_industri/load_data_select_purchase_sperpart_industri/',
            dataType: 'json',
            delay: 100,
            cache: true,
      ...
      function save_detail(value,detail_id,type){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Receipt_sperpart_industri/action_data_detail/',
