                                  ...
                                  <thead>
                                    <!--<tr>
                                      <td colspan="7">
                                        <div class="form-group">
                                          ...
                                          &nbsp;&nbsp;&nbsp;&nbsp;
                                          <label>
                                              <input type="radio" onclick="type_detail(6)" name="i_type" id="inlineRadio5" value="6"> Bahan Packaging
                                          </label>
                                        </div>
                                      </td>
                                    </tr>-->
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <div id="packaging" >
                                          <select id="i_packaging" class="form-control select2" name="i_packaging" style="width: 100%;" onchange="get_packaging_price(this.value)">
                                          </select>
                                        </div>
                                      </td>
...
<script type="text/javascript">
    ...
    function search_data() { 
        $('#table1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Purchase_packaging/load_data/'
            },
            "columns": [
              {"name": "purchase_code"},
              {"name": "partner_name"},
    ...
    function search_data_detail(id) { 
        $('#table2').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Purchase_packaging/load_data_detail/'+id
            },
            "columns": [
    ...
    function action_data(){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Purchase_packaging/action_data/',
    ...
    function delete_data(id) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Purchase_packaging/delete_data',
                data: 'id='+id,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function edit_data(id) {
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Purchase_packaging/load_data_where/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
    ...
    function select_list_partner() {
      ...
      function select_list_packaging() {
        $('#i_packaging').select2({
      ...
      function save_detail(){
        ...
        var id2 = document.getElementById("i_packaging").value;
        if (id) {
          var id_new = id;
        }else{
          var id_new = 0;
        ...
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Purchase_packaging/action_data_detail/'+id2,
          data : $( "#formall" ).serialize(),
          dataType : "json",
          success:function(data){
            if(data.status=='200'){
      ...
      function edit_data_detail(id){
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Purchase_packaging/load_data_where_detail/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
            //reset3();
            for(var i=0; i<data.val.length;i++){
              ...
              }else if (data.val[i].purchase_detail_type == 6) {
                $("#i_packaging").append('<option value="'+data.val[i].purchase_detail_data_id+'" selected>'+data.val[i].package_name+'</option>');
                document.getElementById('item').style.display     = 'none';
                document.getElementById('sperpart').style.display = 'none';
                document.getElementById('material').style.display = 'none';
                document.getElementById('packaging').style.display = 'block';
      ...
      function delete_data_detail(id_detail) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Purchase_packaging/delete_data_detail',
                data: 'id='+id_detail,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function get_packaging_price(id) {
        $.ajax({
          type : "GET",
          ...
          success:function(data){
            for(var i=0; i<data.val.length;i++){
               $('input[name="i_detail_price"]').val(data.val[i].package_price);
            }
          }
        });
    }
