                    ...
                    <div class="box-content">
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group" id="machine" style="display: none;">
                            <label>Mesin</label>
...
<script type="text/javascript">
    ...
    function search_data() { 
        $('#table1').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Service_vehicle/load_data/'
            },
            "columns": [
    ...
    function search_data_detail(id) { 
        $('#table2').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Service_vehicle/load_data_detail/'+id
            },
            "columns": [
    ...
    function action_data(){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Service_vehicle/action_data/',
    ...
    function delete_data(id) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Service_vehicle/delete_data',
                data: 'id='+id,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function edit_data(id) {
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Service_vehicle/load_data_where/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
      ...
      function save_detail(){
        ...
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Service_vehicle/action_data_detail/',
          data : $( "#formall" ).serialize(),
          dataType : "json",
          success:function(data){
            if(data.status=='200'){
      ...
      function edit_data_detail(id){
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Service_vehicle/load_data_where_detail/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
            for(var i=0; i<data.val.length;i++){
      ...
      function delete_data_detail(id_detail) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Service_vehicle/delete_data_detail',
                data: 'id='+id_detail,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
