                                ...
                                <table width="100%" id="table2" class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                  ...
                                  <thead>
                                    <tr>
                                      ...
                                      <td>
                                        <input type="text" class="form-control money" name="i_price" placeholder="Masukkan Harga Khusus" onkeydown="if (event.keyCode == 13) { save_price(); }">
                                      </td>
                                      <td>
                                        <input type="text" class="form-control money" name="i_promo1" placeholder="Masukkan Harga Promo" onkeydown="if (event.keyCode == 13) { save_price(); }">
                                      </td>
                                      <td>
                                        <input type="text" class="form-control money" name="i_promo2" placeholder="Masukkan Harga Promo" onkeydown="if (event.keyCode == 13) { save_price(); }">
                                      </td>
