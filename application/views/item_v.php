...
<script type="text/javascript">
    ...
    function search_data_color(id) { 
        $('#table2').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Item/load_data_color/'+id
            },
            "columns": [
              {"name": "item_detail_id"},
    ...
    function search_data_formula(id) { 
        $('#table3').DataTable({
            ...
            "serverSide": true,
            ajax: {
              url: '<?php echo base_url();?>Item/load_data_formula/'+id
            },
            "columns": [
    ...
    function action_data(){
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Item/action_data/',
    ...
    function delete_data(id) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Item/delete_data',
                data: 'id='+id,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function select_list_type() {
        $('#i_type').select2({
          ...
          allowClear: true,
          ajax: {
            url: '<?php echo base_url();?>Item/load_data_select_type/',
            dataType: 'json',
            delay: 100,
            cache: true,
      ...
      function save_color(){
        ...
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Item/action_data_color/',
          data : $( "#formall" ).serialize(),
          dataType : "json",
          success:function(data){
            if(data.status=='200'){
      ...
      function edit_data_color(id){
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Item/load_data_where_color/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
            for(var i=0; i<data.val.length;i++){
      ...
      function delete_data_color(id_detail) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Item/delete_data_color',
                data: 'id='+id_detail,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function save_formula(){
        ...
        $.ajax({
          type : "POST",
          url  : '<?php echo base_url();?>Item/action_data_formula/',
      ...
      function edit_data_formula(id){
        $.ajax({
          type : "GET",
          url  : '<?php echo base_url();?>Item/load_data_where_formula/',
          data : "id="+id,
          dataType : "json",
          success:function(data){
            for(var i=0; i<data.val.length;i++){
      ...
      function delete_data_formula(id_formula) {
        ...
        if(a==true){
            $.ajax({
                url: '<?php echo base_url();?>Item/delete_data_formula',
                data: 'id='+id_formula,
                type: 'POST',
                dataType: 'json',
                success: function (data) {
    ...
    function get_filename(elm) {
      ...
      $.ajax({
        type: 'POST',
        url: '<?=site_url('Item/import_excel')?>',
        data: formData,
        dataType: 'json',
